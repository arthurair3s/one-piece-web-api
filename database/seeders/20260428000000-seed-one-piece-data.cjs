...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('character_versions', [
      { id: 1, character_id: 1, alias: 'Luffy (Início)', epithet: 'Chapéu de Palha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/luffy-eb.png', description: 'O protagonista que sonha em se tornar o Rei dos Piratas.', createdAt: now, updatedAt: now },
      { id: 2, character_id: 2, alias: 'Zoro (Início)', epithet: 'Caçador de Piratas', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/zoro-eb.png', description: 'O lendário caçador de recompensas que usa três espadas.', createdAt: now, updatedAt: now },
      { id: 3, character_id: 3, alias: 'Nami (Início)', epithet: 'Gata Ladra', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/nami-eb.png', description: 'Uma navegadora genial e ladra especializada em roubar piratas.', createdAt: now, updatedAt: now },
      { id: 4, character_id: 7, alias: 'Buggy (O Palhaço)', epithet: 'O Palhaço', bounty: 15000000, status: 'ALIVE', image_url: 'https://images.grandline.com/buggy-eb.png', description: 'Capitão pirata usuário da Bara Bara no Mi que aterroriza Orange Town.', createdAt: now, updatedAt: now },
      { id: 5, character_id: 4, alias: 'Coby (Recruta)', epithet: 'Recruta da Marinha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/coby-eb.png', description: 'Jovem covarde que quer se tornar um oficial da Marinha.', createdAt: now, updatedAt: now },
      { id: 6, character_id: 5, alias: 'Alvida (Clava)', epithet: 'Clava de Ferro', bounty: 5000000, status: 'ALIVE', image_url: 'https://images.grandline.com/alvida-eb.png', description: 'A capitã gorda que aterrorizava Coby antes de Luffy surgir.', createdAt: now, updatedAt: now },
      { id: 7, character_id: 1, alias: 'Luffy (Orange Town)', epithet: 'Chapéu de Palha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/luffy-eb.png', description: 'O capitão pirata que procura aliados no East Blue.', createdAt: now, updatedAt: now },
      { id: 8, character_id: 2, alias: 'Zoro (Orange Town)', epithet: 'Caçador de Piratas', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/zoro-eb.png', description: 'Espadachim do bando, ferido na luta contra Buggy.', createdAt: now, updatedAt: now },
      { id: 9, character_id: 8, alias: 'Chouchou', epithet: 'Cão de Orange Town', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/chouchou.png', description: 'Um cão incrivelmente leal que guarda o pet shop do seu falecido dono.', createdAt: now, updatedAt: now },
      { id: 10, character_id: 1, alias: 'Luffy (Syrup)', epithet: 'Chapéu de Palha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/luffy-eb.png', description: 'Capitão do bando que busca um navio de verdade.', createdAt: now, updatedAt: now },
      { id: 11, character_id: 2, alias: 'Zoro (Syrup)', epithet: 'Caçador de Piratas', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/zoro-eb.png', description: 'Espadachim que protege a encosta contra os piratas Kuroneko.', createdAt: now, updatedAt: now },
      { id: 12, character_id: 3, alias: 'Nami (Syrup)', epithet: 'Gata Ladra', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/nami-eb.png', description: 'Navegadora temporária focada no ouro.', createdAt: now, updatedAt: now },
      { id: 13, character_id: 9, alias: 'Usopp (Início)', epithet: 'Sniper do Bando', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/usopp-eb.png', description: 'Um jovem mentiroso que sonha em se tornar um valente guerreiro do mar.', createdAt: now, updatedAt: now },
      { id: 14, character_id: 10, alias: 'Kaya', epithet: 'Herdeira de Syrup', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/kaya.png', description: 'Uma jovem herdeira doente que adora ouvir as histórias fantasiosas de Usopp.', createdAt: now, updatedAt: now },
      { id: 15, character_id: 11, alias: 'Capitão Kuro', epithet: 'Kuro das Centenas de Planos', bounty: 16000000, status: 'ALIVE', image_url: 'https://images.grandline.com/kuro.png', description: 'O temido capitão pirata que finge ser o dócil mordomo Klahadore para roubar Kaya.', createdAt: now, updatedAt: now },
      { id: 16, character_id: 1, alias: 'Luffy (Baratie)', epithet: 'Chapéu de Palha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/luffy-eb.png', description: 'Trabalha como faxineiro temporário para pagar um estrago feito no restaurante.', createdAt: now, updatedAt: now },
      { id: 17, character_id: 2, alias: 'Zoro (Baratie)', epithet: 'Caçador de Piratas', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/zoro-eb.png', description: 'Encontra Dracule Mihawk e decide desafiá-lo para um duelo.', createdAt: now, updatedAt: now },
      { id: 18, character_id: 3, alias: 'Nami (Baratie)', epithet: 'Gata Ladra', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/nami-eb.png', description: 'Foge secretamente levando o navio Going Merry rumo ao Arlong Park.', createdAt: now, updatedAt: now },
      { id: 19, character_id: 9, alias: 'Usopp (Baratie)', epithet: 'Sniper do Bando', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/usopp-eb.png', description: 'Tenta perseguir Nami junto com Zoro e Johnny.', createdAt: now, updatedAt: now },
      { id: 20, character_id: 12, alias: 'Sanji', epithet: 'Perna Negra', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/sanji-eb.png', description: 'Subchefe de cozinha do Baratie, conhecido por sua comida divina e pontapés ferozes.', createdAt: now, updatedAt: now },
      { id: 21, character_id: 13, alias: 'Don Zeff', epithet: 'Perna Vermelha', bounty: 0, status: 'ALIVE', image_url: 'https://images.grandline.com/zeff.png', description: 'O chef fundador do Baratie e ex-capitão pirata que salvou a vida de Sanji no passado.', createdAt: now, updatedAt: now },
      { id: 22, character_id: 14, alias: 'Don Krieg', epithet: 'O Almirante Pirata', bounty: 17000000, status: 'ALIVE', image_url: 'https://images.grandline.com/krieg.png', description: 'Líder da maior armada pirata do East Blue, destruída na Grand Line.', createdAt: now, updatedAt: now },
      { id: 23, character_id: 15, alias: 'Mihawk', epithet: 'Olhos de Gavião', bounty: 3590000000, status: 'ALIVE', image_url: 'https://images.grandline.com/mihawk.png', description: 'Membro dos Shichibukai e o maior espadachim do mundo.', createdAt: now, updatedAt: now }
    ], { ignoreDuplicates: true });
